...
const LeftNav = () => {
    ...
    const leftNavTopBoxProps: SxProps = { width: 1, color: "#09B7D8", backgroundColor: "white", mt: "72px" };
    ...
    const leftNavHeaderProps: SxProps = {
        fontSize: "16px", width: 1, color: "black", backgroundColor: "white", pl: 2, mb: 0, mt: 0, py: "2px", borderLeft: "1px solid #888888"
    };

    const leftNavListProps: SxProps = {
        mt: 0, pt: 0, borderLeft: "1px solid #888888", fontSize: "14px", width: 1, my: 0, py: 0, color: "black"
    };
    ...
    return (
        <Drawer variant='permanent' anchor='left'
            ...
            PaperProps={{ sx: { width: leftNavWidth, backgroundColor: "white", border: "2px #0592BD", boxShadow: "1px 5px 5px 2px #0000003d" } }}  >
                ...
                <Box sx={leftNavOuterBoxProps} >
                    ...
                    <Box sx={leftNavInnerBoxRightProps}>
                        <FormControl sx={{ width: 1, display: leftNavExpanded ? "inline-flex" : "none" }}>
                            <Select size='small' sx={{ height: "42px", pl: 1 }} value={appContextData?.currentWorkspaceId ?? ""}
